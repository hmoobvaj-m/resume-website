        ...
        return (
            ...
            <section className="border-t border-neutral-700 py-8">
                ...
                {resumeData.experience.map((item) => (
                    ...
                    className="rounded-2xl border border-neutral-700 p-6"
                    >
                    <div className="flex flex-col gap-2 md:flex-row md:items-start md:justify-between">
                        <div>
            ...
            <section className="border-t border-neutral-700 py-8">
                ...
                <div className="rounded-2xl border border-neutral-700 p-6">
                    ...
                    <p className="mt-3 text-neutral-200">{resumeData.skills.programming.join(", ")}</p>
                </div>

                <div className="rounded-2xl border border-neutral-700 p-6">
                    <h3 className="text-lg font-semibold text-white">AI/ML</h3>

                    <p className="mt-3 text-neutral-200">{resumeData.skills.aiMl.join(", ")}</p>
                </div>

                <div className="rounded-2xl border border-neutral-700 p-6">
                    <h3 className="text-lg font-semibold text-white">Robotics</h3>

                    <p className="mt-3 text-neutral-200">{resumeData.skills.robotics.join(", ")}</p>
                </div>

                <div className="rounded-2xl border border-neutral-700 p-6">
                    <h3 className="text-lg font-semibold text-white">Infrastructure</h3>

                    <p className="mt-3 text-neutral-200">{resumeData.skills.infrastructure.join(", ")}</p>
                </div>
                </div>
            </section>
            </main>
